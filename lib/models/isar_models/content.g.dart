...
void _contentSerialize(
  ...
  writer.writeDouble(offsets[1], object.priority);
...
Content _contentDeserialize(
  ...
  object.priority = reader.readDouble(offsets[1]);
...
extension ContentQueryFilter
  ...
  QueryBuilder<Content, Content, QAfterFilterCondition> dueDateIsNull() {
  ...
  QueryBuilder<Content, Content, QAfterFilterCondition> dueDateIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Content, Content, QAfterFilterCondition> dueDateEqualTo(
      DateTime? value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Content, Content, QAfterFilterCondition> dueDateGreaterThan(
    DateTime? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Content, Content, QAfterFilterCondition> dueDateLessThan(
    DateTime? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Content, Content, QAfterFilterCondition> dueDateBetween(
    DateTime? lower,
    DateTime? upper, {
  ...
  QueryBuilder<Content, Content, QAfterFilterCondition> priorityEqualTo(
    double value, {
  ...
  QueryBuilder<Content, Content, QAfterFilterCondition> priorityGreaterThan(
    double value, {
    bool include = false,
    double epsilon = Query.epsilon,
  }) {
  ...
  QueryBuilder<Content, Content, QAfterFilterCondition> priorityLessThan(
    double value, {
    bool include = false,
    double epsilon = Query.epsilon,
  }) {
  ...
  QueryBuilder<Content, Content, QAfterFilterCondition> priorityBetween(
    double lower,
    double upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Content, Content, QAfterFilterCondition> textIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'text',
      ));
  ...
  QueryBuilder<Content, Content, QAfterFilterCondition> textIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'text',
      ));
